...
import EcorpCard from '../assets/Lanyard/card-lanyard.png';
    ...
    return (
        ...
        >
            ...
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
                <div className="flex-1 dark:text-white text-slate-800 space-y-6 pt-16 md:pt-40 order-last md:order-none text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.55, ease: "easeOut" }}>
                        <TextGenerateEffect words={["Cybersecurity is my domain. I don't defend—I dominate. Vulnerability hunter. Threat annihilator. Secure systems enforced."]} />
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.0, ease: "easeOut" }} className="flex flex-row gap-4 mt-8">
                        ...
                        <a href="https://instagram.com/packet_elvis" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border dark:border-slate-700 border-slate-200 dark:bg-slate-900/[0.8] bg-white text-slate-600 dark:text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:shadow-md dark:hover:shadow-[0_0_24px_2px_#00ffdc]">
                        ...
                        <a href="https://www.linkedin.com/in/elvis-mbugua-89b177331/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border dark:border-slate-700 border-slate-200 dark:bg-slate-900/[0.8] bg-white text-slate-600 dark:text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:shadow-md dark:hover:shadow-[0_0_24px_2px_#00ffdc]">
                ...
                {/* ECORP Card Display */}
                <div className="hidden lg:flex flex-1 justify-center items-center h-[600px] w-full order-first lg:order-none">
                    <img 
                        src={EcorpCard} 
                        alt="ECORP Card" 
            ...
            >
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.6, ease: "easeOut" }} className="text-center">
                    ...
                    <p className="text-lg dark:text-cyan-200/70 text-slate-600 mt-2 font-cascadia px-1 mb-20">
                      ✦ Obsessed with forging unbreakable code and weaponizing creative tech ✦
                    </p>
                </motion.div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center">
                    ...
                    >
                        ...
                        <h3 className="text-4xl font-bold dark:text-white text-slate-900 my-2 font-moderniz" style={{ textShadow: theme === 'dark' ? "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" : "none" }}>Elvis Mbugua Muchiri</h3>
                        <p className="dark:text-white/80 text-slate-600 leading-relaxed mt-4 font-cascadia text-justify">
                            As a tenacious Bachelor of Information Technology candidate at KCA University, I specialize in cybersecurity and secure software engineering, architecting unbreakable defenses against the relentless onslaught of digital adversaries. Forged in the crucible of Moringa School's intensive software development program and sharpened by AfricaHackon's elite cybersecurity challenges, I hunt vulnerabilities with surgical precision, pioneer cuttingedge security research, and engineer resilient systems that dismantle real-world threats before they strike.
                        </p>
            ...
            <footer className="py-12 pb-16 text-center text-gray-400 dark:bg-gradient-to-t dark:from-slate-900/50 dark:to-transparent bg-gradient-to-t from-slate-100/50 to-transparent">
                <div className="text-sm">© {new Date().getFullYear()} Elvis Mbugua. All rights reserved.</div>
